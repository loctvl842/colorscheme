local highlights = {
	...
	Pmenu = { fg = C.light_gray, bg = C.dark },
	PmenuSel = { bg = C.select },
	...
	String = { fg = C.yellow }, -- tvl1
	Character = { fg = C.light_green }, -- tvl1
	Constant = { fg = C.vivid_blue },
	Number = { fg = C.light_green },
	Noise = { fg = C.white }, -- tvl1
	Boolean = { fg = C.blue },
	...
	Include = { fg = C.purple },
	PreProc = { fg = C.purple }, -- tvl
	Define = { fg = C.purple },
	Macro = { fg = C.purple },
	PreCondit = { fg = C.purple },
	Special = { fg = C.light_green }, -- tvl
