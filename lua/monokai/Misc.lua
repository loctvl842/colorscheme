local Misc = {
	...
	cssProp = { fg = C.blue, style = "bold,italic" },
	sassAmpersand = { fg = C.red },
	sassDefinition = { fg = C.blue },
	cssPseudoClass = { fg = C.green },
	cssPseudoClassId = { fg = C.green },
	cssValueNumber = { fg = C.purple },
	cssValueLength = { fg = C.purple },
	cssUnitDecorators = { fg = C.red },
	cssPageProp = { fg = C.red },
	sassProperty = { fg = C.blue },
	cssCustomProp = { fg = C.white },
	cssTagName = { fg = C.red },
	sassMixing = { fg = C.red },
	sassMixinName = { fg = C.green },
	sassCssAttribute = { fg = C.purple },
	cssUIProp = { fg = C.red },
